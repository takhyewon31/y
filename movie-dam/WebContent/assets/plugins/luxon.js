...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_217__) {
...
var luxon_1 = __webpack_require__(217);
...
function toDuration(duration, calendar) {
    ...
    return luxon_1.Duration.fromObject(fc.assignTo({}, duration, {
        locale: calendar.dateEnv.locale.codes[0]
    }));
}
