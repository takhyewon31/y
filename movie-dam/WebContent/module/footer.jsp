         ...
         <div class="col-12 d-md-flex align-items-center justify-content-between">
            <div class="footer-text">
               <p>
                  ...
                  All rights reserved | Made with <i class="fas fa-heart" aria-hidden="true"></i> 
...
<script src="/movie-dam/assets/js/calendar/jquery-ui.custom.min.js"></script>
<script src="/movie-dam/assets/js/calendar/fullcalendar.js"></script>
<script src="/movie-dam/assets/js/calendar/jquery-1.10.2.js"></script>
