        ...
        <div class="card card-profile shadow mt--300">
          <div class="px-4">
            ...
            <div class="text-center mt-5">
              <h3><a href="profile.jsp?mem_userid=<%=mem_userid%>"><%=user_profile.getMem_nickname() %></a>
                <span class="font-weight-light" id="birth"></span>
              </h3>
              <div class="h6 font-weight-300"><i class="ni location_pin mr-2"></i><%=user_profile.getMem_email() %></div>
            </div>
		                ...
		                <div class="reviewer-meta d-flex align-items-center">
		                    ...
		                    <div class="reviewer-content">
		                        <div class="review-title-ratings d-flex justify-content-between">
		                            <h6><a href="profile.jsp?mem_userid=<%=follower_profile.getMem_userid()%>"><%=follower_profile.getMem_nickname() %> <small>(<%=follower.getMem_id() %>)</small></a></h6>
		                        </div>
		                        <p> 자기소개가 없습니다.</p>
		                    </div>
		                </div>
